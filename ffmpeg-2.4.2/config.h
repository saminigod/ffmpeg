...
#define FFMPEG_CONFIGURATION "--enable-static --prefix=./vs2013_build --enable-debug --toolchain=msvc"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2014
#define FFMPEG_DATADIR "./vs2013_build/share/ffmpeg"
#define AVCONV_DATADIR "./vs2013_build/share/ffmpeg"
#define CC_IDENT "用于 x86 的 Microsoft (R) C/C++ 优化编译器 18.00.21005.1 版版权所有(C) Microsoft Corporation。 保留所有权利。"
